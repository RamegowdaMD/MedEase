      ...
      {/* Product data */}
          ...
          <div className="flex-1 flex flex-col-reverse gap-3 sm:flex-row">
            ...
            <div className="w-full sm:w-[80%]">
              ...
              <div className='flex-1'>
                <h1 className='font-serif font-medium text-2xl mt-2'> {productData.name}</h1>
                ...
                <div className='text-sm text-gray-500 mt-5 flex flex-col gap-1'>
                  ...
                  <p className="">easy return and exchange policy within 3 days</p>
                </div>
              </div>
        </div>
        {/* Review section */}
        ...
        <div className="mt-20">
          ...
          <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500 ">
            ...
            <p>Facere eligendi assumenda enim veniam delectus commodi in cum beatae ullam, nostrum expedita?</p>
          </div>
        </div>
